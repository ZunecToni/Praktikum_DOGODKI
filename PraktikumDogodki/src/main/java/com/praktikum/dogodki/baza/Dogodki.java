...
// SPREMEMBA PRI DATE SETTERIH IZ Date date v java.util.Date
		public Date getZacetek() {
			return zacetek;
		}

		public void setZacetek(java.util.Date date) {
			this.zacetek =  (Date) date;
		}
		...
		public void setTrajanje(java.util.Date date) {
			this.trajanje = (Date) date;
		}
		...
		public void setKonecOdjav(java.util.Date date) {
			this.konecOdjav =  (Date) date;
		}
